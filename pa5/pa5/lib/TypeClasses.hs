...
dOrdXY d1 d2 = MkOrd (\(x1, y1) (x2, y2) ->
                       case compare d1 x1 x2 of
                         EQ -> compare d2 y1 y2
                         r -> r)
...
dOrdYX d1 d2 = MkOrd (\(x1, y1) (x2, y2) ->
                       case compare d2 y1 y2 of
                         EQ -> compare d1 x1 x2
                         r -> r)
...
sortIntDesc' _ xs = sort dOrdIntDesc xs
sortIntDesc' _ xs =
